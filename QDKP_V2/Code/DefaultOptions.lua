...
QDKP2_BidM_HideWispBids 	    = true	-- if true, the whispers you get from your guild members for bids will not be shown.
...
QDKP2_BidM_MinBid            	= 100	-- Enter here the minimum bid allowed in your guild.
...
QDKP2_LOCALIZE_MESSAGES = true		--if this is set to false, only GUI will be localized but all messages sent in English
...
QDKP2_SENDTRIG_MODIFY = true     --upload when a player's amounts are manually edited
...
QDKP2GUI_Default_RaidBonus	= 100
QDKP2GUI_Default_TimerBonus   	= 0
QDKP2GUI_Default_IMBonus      	= 0
QDKP2GUI_Default_QuickMod     	= 100
