...
if GetLocale()=='ruRU' then
  ...
  if QDKP2_LOCALIZE_MESSAGES then
    ...
    QDKP2_LOC_BidEqual = "Ваша ставка равна предыдущей."
    QDKP2_LOC_BidLess = "Ваша ставка меньше предыдущей."
    QDKP2_LOC_BidGreater = "Вы не можете ставить больше DKP, чем у Вас есть. Максимальная ставка, которую Вы можете сделать - $NET DKP."
    QDKP2_LOC_BidnoDKP = "Минимальная ставка $MINBID DKP. У Вас есть $NET."
    QDKP2_LOC_BidNoGuild = "Только члены гильдии могут делать ставки."
    QDKP2_LOC_BidLessMinimum = "Минимальная ставка $MINBID DKP"
    QDKP2_LOC_BidMoreMaximum = "Максимальная ставка $MAXBID DKP"
    ...
    QDKP2_LOC_BidLessCurrentBid = "Минимальный шаг: $MINSTEP DKP."
  end
  ...
  QDKP2_LOC_AutoBoss="Принимает участие в сессии $SESSION"
